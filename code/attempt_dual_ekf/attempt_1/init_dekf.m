...
% setup state-ekf
% x = [1/C; 1/R; 1/R0; SOC; U_rc; i_b]
% Initial value: x1_0 = 2/790.27; x2_0 = 1/0.0252; x3_0 = 1/0.0172;
% x4_0 = 50%; x5_0 = 0; x6_0 = x3_0*(u_L(0) - x5_0 - uoc(x4_0))

x_0 = [2/790.27; 1/0.0252; 1/0.0172; 0.5; 0; (volt_est.Data(1)-u_oc0)/0.0172];
...
P_0(6,6) = (cur_est.Data(1)-x_0(6))^2;
...
% setup i_L-ekf
% x_L = [i_L; i_b]
% Initial value: x_L1_0 = 0; x_L2_0 = x6_0
x_L_0 = [0; x_0(6)];

% set covariance matrix for i_L-ekf
i_L_soll = cur_est.Data(1)+Cg/Delta*(volt_est.Data(2)-volt_est.Data(1));
P_L_0 = eye(2); P_L_0(1,1) = (-i_L_soll)^2; P_L_0(2,2) = P_0(6,6);

% error variance matrix for i_L-ekf
W_L_k = 0*eye(2); W_L_k(1,1) = 0.05; % random number (can be tuned)
