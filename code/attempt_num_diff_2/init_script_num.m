...
[~,ind] = min(abs(cur_est.Time - t_static));
static_ = cur_est.Data(1:ind);
Z_k = var(static_);

clear t_static ind static_
%% SOC-Graph
...
x0 = [2/(2.9*3600/12); 1/42e-3/2; 1/42e-3/2; Cg/y_km1; 0.65; 0; cur_est.Data(1)];
